...
const drawNode = (d) => {
  const spritePos = spritePositions[d.code]
  context.fillStyle = 'black'
  context.strokeRect(d.x - spriteWidth / 2 - .5, d.y - spriteHeight / 2 - .5,
    spriteWidth + 1, spriteHeight + 1)
  context.drawImage(flags,
                    spritePos.x, spritePos.y,
                    spriteWidth, spriteHeight,
                    d.x - spriteWidth / 2, d.y - spriteHeight / 2,
                    spriteWidth, spriteHeight)
}
